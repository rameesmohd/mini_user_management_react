...
const Login = () => {
    ...
    const adminFormSubmit = (e) => {
        e.preventDefault();
        adminAxios.post("/admin_login", { email, password }).then((response) => {
    ...
    <div class="container-fluid h-custom">
        <div class="row d-flex justify-content-center align-items-center h-100">
            ...
            <div class="col-md-9 col-lg-6 col-xl-5">
                <img src="https://kinsta.com/wp-content/uploads/2017/12/wordpress-admin-1024x512.png" class="img-fluid" alt="Sample image" />
            </div>
